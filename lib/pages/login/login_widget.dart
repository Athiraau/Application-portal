                                ...
                                Row(
                                  ...
                                  children: [
                                    Expanded(
                                      child: Align(
                                        alignment:
                                            const AlignmentDirectional(-0.20, -0.55),
                                        child: Padding(
                                          padding:
                                                                            ...
                                                                            await showDialog(
                                                                              ...
                                                                              builder: (alertDialogContext) {
                                                                                return AlertDialog(
                                                                                  ...
                                                                                  content: const Text('Please Enter UserId'),
                                                                                  actions: [
                                                                                    TextButton(
                                                                                      onPressed: () => Navigator.pop(alertDialogContext),
                                                                                      child: const Text('Ok'),
                                                                            ...
                                                                            if (_model.passwordController.text == '') {
                                                                              ...
                                                                              if ((FFAppState().isSuccess == 'True') || (FFAppState().isSuccess == 'Warning')) {
                                                                                ...
                                                                                if (FFAppState().result == 'Success') {
                                                                                  ...
                                                                                  _model.encodeBase64Copy = await actions.encodeBase64(
                                                                                    FFAppState().session,
                                                                                  );
                                                                                  shouldSetState = true;
                                                                                  setState(() {
                                                                                    FFAppState().sessionencrypt = _model.encodeBase64Copy!;
                                                                                  });
